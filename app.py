...
st.write("""
|抗侧力体系 |$S/m^2$ <br/> (1) | $L/m, B/m, N$  <br/> (2)               | $L/m, H/m, N, T/s$    <br/> (3)                           | $H/m$  <br/> (4)                |
|-----|--------------    |------------------------                |-------------------------------------                      |---------------------------------|
|框架-核心筒 | $W = 16.737S$    | $lgW = 1.062lgN + 0.506lg(LB) + 2.750$ | $lgW = 0.697lgH + 0.610lgL + 0.552lgN - 0.144lgT + 2.727$ | $W = 424.46H^{1.497} + 349454$ |
|框架-剪力墙 | $W = 18.004S$    | $lgW = 0.932lgN + 0.783lg(LB) + 2.010$ | $lgW = 1.192lgH + 1.233lgL - 0.189lgN + 0.0699lgT + 1.519$ |        --                       |
|  剪力墙 | $W = 18.724S$    | $lgW = 1.050lgN + 0.907lg(LB) + 1.380$ | $lgW = 1.750lgH + 0.910lgL - 0.260lgN - 0.187lgT + 1.037$ | $lgW = 1.458lgH + 2.628$        |
|  框架  | $W = 15.181S$    | $lgW = 1.019lgN + 0.960lg(LB) + 1.231$ | $lgW = 1.198lgH + 1.305lgL + 0.301lgN - 0.0569lgT + 0.871$ | $lgW = 2.390lgH + 1.823$        | 
